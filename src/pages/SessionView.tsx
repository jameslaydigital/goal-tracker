        ...
        {data ? (
          <>
            ...
            <div className="flex flex-col gap-2 flex-1">
              {displayExercises.map(ex => {
                ...
                return (
                  <div
                    key={ex.id}
                    className="bg-surface-800 rounded-xl overflow-hidden"
                  >
                    <button
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <button
                onClick={() => {
                  const id = prompt('Exercise ID to remove:')
                  if (id) removeExerciseFromSession(id)
                }}
                className="w-full py-3 rounded-xl border border-surface-800 text-surface-600 text-sm active:bg-surface-800 transition-colors"
              >
